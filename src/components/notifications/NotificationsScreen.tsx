...
+  useEffect(() => {
+    const shouldShow = permissionStatus === 'default' || (permissionStatus === 'granted' && !isSubscribed);
...
+            forceShow={true}
+            onPermissionGranted={() => setShowPermissionBanner(false)}
...
+                  <Button onClick={handleEnableNotifications} disabled={permissionStatus === 'denied'}>
